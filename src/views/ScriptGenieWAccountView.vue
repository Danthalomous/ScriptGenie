  ...
  <v-container>
    ...
    <v-row justify="center">
      ...
      <v-col>
        ...
        <div>
          <v-text-field clearable label="Organization Name" variant="outlined" placeholder="Nampa Christian Football" v-model="homeOrganizationData.OrganizationName" />
      ...
      <v-col>
        ...
        <div>
          <v-text-field clearable label="Organization Name" variant="outlined" placeholder="Melba" v-model="awayOrganizationData.OrganizationName" />
        ...
        <div>
          <v-checkbox label="Next Game Info" v-model="nextGameData.enabled" @change="updateNextGameDataEnabled()"></v-checkbox>
            <div v-if="nextGameData.enabled">
              ...
              <br>
              <br>
              <v-text-field clearable label="Opponent Name" variant="outlined" placeholder="New Plymouth" v-model="nextGameData.nextOpponentName" />
              ...
              <v-text-field clearable label="Opponent Mascot" variant="outlined" placeholder="Pilgrims" v-model="nextGameData.nextOpponentMascot" />
              ...
              <v-text-field clearable label="Game Location" variant="outlined" placeholder="Nampa Christian Orchard Campus" v-model="nextGameData.nextGameLocation" />
